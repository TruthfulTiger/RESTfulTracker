$(function () {
	...
	function facialHairRand() {
		...
		if (!female) {
			hair = facialHairChance.val() / 100;
			nohair = (100 - facialHairChance.val()) / 100;
			list = ['nohair', 'hair'];
			weight = [nohair, hair];
		} else {
			hair = 0;
	...
	function glassesRand() {
		...
		list = ['noglasses', 'glasses'];
		weight = [noglasses, glasses];
	...
	function makeUpRand() {
		...
		list = ['nomakeUp', 'makeUp'];
		weight = [nomakeUp, makeUp];
	...
	function supernaturalRand() {
		...
		list = ['human', 'supernatural'];
		weight = [human, supernatural];
